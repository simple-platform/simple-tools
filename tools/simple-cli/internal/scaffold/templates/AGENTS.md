...
- **TDD:** Follow **Test-Driven Development**. Write tests _before_ implementation.
...
- **Data Privacy:** "Treat User Data as Toxic."
  - **Least Privilege:** In GraphQL, fetch _only_ the fields you need (Projection).
...
- **Structure:**
  - **Inline:** Explain _why_, not _what_. well-named variables reduce the need for comments.
