defmodule SCLParser.CLI do
  @moduledoc """
  CLI entry point for checking SCL files and outputting JSON.
  """
  ...
  defp parse_args(_), do: {:error, "Usage: scl_parser <file.scl>"}
  ...
  # AST: [ {{:key, l, c}, {val, l, c}} ]
  # Converted: [ { "key": "key", "key_meta": {l,c}, "value": val, "val_meta": {l,c} } ] ?
  # Or just arrays: [ ["key", meta], ["val", meta] ]
  # Let's go with arrays for tuples: {a, b} -> [a, b]
